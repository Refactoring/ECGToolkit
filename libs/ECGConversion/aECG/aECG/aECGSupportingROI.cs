...
{
	public sealed class aECGSupportingROI : aECGElement
	{
		private string _InnerName = null;

		public aECGCode Code = new aECGCode();
		public aECGBoundary[] Boundary = new aECGBoundary[128];

		public aECGSupportingROI() : base("support")
		{
			_InnerName = "supportingROI";
		}
