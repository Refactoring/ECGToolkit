...
{
	public sealed class aECGPerformer : aECGElement
	{
		private string _InnerName = null;

		public aECGId Id = new aECGId();
		public aECGPerson AssignedPerson = new aECGPerson("assignedPerson");

		public aECGPerformer() : base("performer")
		{
			_InnerName = "studyEventPerformer";
		}
