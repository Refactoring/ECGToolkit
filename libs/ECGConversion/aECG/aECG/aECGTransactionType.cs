...
{
	public sealed class aECGTransactionType : aECGElement
	{
		public const string TransactionTypeName = "transactionType";

		public aECGCode Code = new aECGCode();
		public aECGValuePair Value = new aECGValuePair("value");

		public aECGTransactionType() : base(TransactionTypeName)
		{
		}
