...
{
	public sealed class aECGClinicalTrial : aECGElement
	{
		private string _InnerName = null;

		public aECGId Id = new aECGId(true);
		public string title = null;
		public aECGTime ActivityTime = new aECGTime("activityTime");
		public aECGSite TrialSite = new aECGSite("trialSite");

		public aECGClinicalTrial() : base("componentOf")
		{
			_InnerName = "clinicalTrial";
		}
