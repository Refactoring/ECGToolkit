...
{
	public sealed class aECGSubjectAssignment : aECGElement
	{
		private string _InnerName = null;

		public aECGTrialSubject Subject = new aECGTrialSubject();
		public aECGSubjectAssignmentDefinition Definition = new aECGSubjectAssignmentDefinition();
		public aECGClinicalTrial ClinicalTrial = new aECGClinicalTrial();

		public aECGSubjectAssignment() : base("componentOf")
		{
			_InnerName = "subjectAssignment";
		}
