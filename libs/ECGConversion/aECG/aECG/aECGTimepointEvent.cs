...
{
	public sealed class aECGTimepointEvent : aECGElement
	{
		...
		public aECGPerformer Performer = new aECGPerformer();
		public aECGSubjectAssignment SubjectAssignment = new aECGSubjectAssignment();

		public aECGTimepointEvent() : base("componentOf")
		{
			_InnerName = "timepointEvent";
		}
