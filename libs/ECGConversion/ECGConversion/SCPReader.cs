/***************************************************************************
Copyright (c) 2004-2005,2008, Thoraxcentrum, Erasmus MC, Rotterdam, The Netherlands
...
{
	/// <summary>
	/// SCPReader class. class to read SCP format.
	/// </summary>
	public class SCPReader : IECGReader
	{
		public SCPReader()
		{}
