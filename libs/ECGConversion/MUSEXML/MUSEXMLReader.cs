...
using ECGConversion.MUSEXML;

namespace ECGConversion
{
	/// <summary>
	/// MUSEXMLReader class. class to read MUSEXML format.
	/// </summary>
	public class MUSEXMLReader : IECGReader
	{
		public MUSEXMLReader()
		{}
