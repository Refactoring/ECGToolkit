...
using ECGConversion.OmronECG;

namespace ECGConversion
{
	/// <summary>
	/// OmronECGReader class. class to read Omron ECG format.
	/// </summary>
	public class OmronECGReader : IECGReader
	{
		public OmronECGReader()
		{}
